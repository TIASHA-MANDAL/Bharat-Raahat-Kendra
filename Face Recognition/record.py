...
def insert_data(name3, loading_window):
    file_pic = 'C:/Users/sbh/Bharat_Rahaat_Kandra/Face Recognition/Images/' + name3 + '.png'
    with open(file_pic, 'rb') as img:
        encoder_str = base64.b64encode(img.read())
        final_str = encoder_str.decode('utf-8')

    file_path = 'C:/Users/sbh/Bharat_Rahaat_Kandra/Face Recognition/Details/' + name3 + '/' + name3 + '.txt'
...
def record1(name):
    ...
    bg = PhotoImage(file = 'C:/Users/sbh/Bharat_Rahaat_Kandra/Face Recognition/Resources/detail.png')
    label1 = Label(root, image = bg)
    label1.place(x = 0, y = 0)
    

    filee='C:/Users/sbh/Bharat_Rahaat_Kandra/Face Recognition/Images/'+name+'.png'
    ...
    fileName1 = 'C:/Users/sbh/Bharat_Rahaat_Kandra/Face Recognition/Details/'+name+'/'+name+'.txt'
