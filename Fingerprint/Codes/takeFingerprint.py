...
def click_save_picture():
    ...
    if os.path.exists(image_path):
        ...
        save_folder = 'C:/Users/sbh/Bharat_Rahaat_Kandra/Fingerprint/dataset/test'
    ...
    finger_recognition('C:/Users/sbh/Bharat_Rahaat_Kandra/Fingerprint/dataset/test/img.bmp')     
